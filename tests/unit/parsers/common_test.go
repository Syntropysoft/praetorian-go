...
func TestValidateFilenameAndExtension(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			result := parsers.ValidateFilenameAndExtension(tt.filename, tt.supportedExts)
...
func TestValidateContextAndInput(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			err := parsers.ValidateContextAndInput(tt.ctx, tt.filename, tt.content)
...
func TestGetFileExtension(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			result := parsers.GetFileExtension(tt.filename)
			if result != tt.expected {
...
func BenchmarkValidateFilenameAndExtension(b *testing.B) {
	...
	for i := 0; i < b.N; i++ {
		parsers.ValidateFilenameAndExtension("test.yaml", exts)
	}
}
